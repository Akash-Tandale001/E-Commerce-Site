  ...
  <div>
    ...
    <footer className="bg-white dark:bg-gray-800">
        <div className="container px-6 py-4 mx-auto">
                ...
                <div className="mt-6 lg:mt-0 lg:flex-1">
                    <div className="grid grid-cols-2 gap-6 sm:grid-cols-3 md:grid-cols-4">
                        <div>
                            ...
                            <a href="#" className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">Term & Condition</a>
                            <a href="#" className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">Services</a>
                        </div>

                        <div>
                            <h3 className="text-gray-700 uppercase dark:text-white">Contact</h3>
                            <span className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">+19123456789</span>
                            <span className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">proakash@email.com</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div>
                <p className="text-center text-gray-800 dark:text-white">© Copyright-2022</p>
            </div>
        </div>
    </footer>
  </div>
